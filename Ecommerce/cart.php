...
<head>
    ...
    <title>Art Gallery-Cart Details</title>
    <!-- bootstrap css link -->
...
<div class="container">
    <div class="row">
       ...
       <table class="table table-bordered text-center">
            ...
            <!-- php code to display dynanimc data -->
            <?php
            global $conn;
    ...
    ?>
       ...
       <div class="d-flex mb-5">
        ...
        if($result_count>0){ 
         ...
         <input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 mx-3 border-0' name='contiue_shopping'>
         <button class='bg-secondary px-3 py-2 border-0 text-light'><a href='./users_area/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>
          ...
          echo "<input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 mx-3 border-0' name='contiue_shopping'>";
        }
