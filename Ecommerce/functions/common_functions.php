           ...
           while($row=mysqli_fetch_assoc($result_query)){
            ...
            <div class='card'>
             ...
             <div class='card-body'>
               ...
               <a href='product_details.php?product_id=$product_id' class='btn btn-secondary'>View More Button</a>
             </div>
             </div>
           </div> ";
           }
...
if(isset($_GET['category']))   
   {
          ...
          $select_query="Select * from `products` where category_id=$category_id";
           ...
           if($num_of_rows==0){
            echo"<h2 class='text-center text-danger '>No Artefacts available for this category</h2>";
           }
          //  $row=mysqli_fetch_assoc($result_query);
          //  echo $row['product_title']
           while($row=mysqli_fetch_assoc($result_query)){
  ...
  if(isset($_GET['search_data_product'])){
          $search_data_value=$_GET['search_data'];
            $search_query="Select * from `products` where product_keywords like '%$search_data_value%' ";
             ...
             $num_of_rows=mysqli_num_rows($result_query);
             if($num_of_rows==0){
              echo"<h2 class='text-center text-danger '>No Results match..No artefacts found related to this</h2>";
             }
             while($row=mysqli_fetch_assoc($result_query)){
              $product_id=$row['product_id'];
              $product_title=$row['product_title'];
